...
class WebhookHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if js['type'] == 'pokemon':
            ...
            individual_defense = int(data['individual_defense']) if data['individual_defense'] is not None else None
            individual_stamina = int(data['individual_stamina']) if data['individual_stamina'] is not None else None
            ...
            gender = int(data['gender']) if data['gender'] is not None else None
            form = int(data['form']) if data['form'] is not None else None
            cp = int(data['cp']) if data['cp'] is not None else None
            cp_multiplier = float(data['cp_multiplier']) if data['cp_multiplier'] is not None else None
