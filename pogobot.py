...
def main():
    ...
    dp.add_handler(CommandHandler("addraid", cmd_addraid, pass_args=True, pass_job_queue=True))
    dp.add_handler(CommandHandler("addraidbylevel", cmd_addraidbylevel, pass_args = True, pass_job_queue=True))
    dp.add_handler(CommandHandler("remraid", cmd_removeraid, pass_args=True, pass_job_queue=True))
    ...
    dp.add_handler(CommandHandler("raidradius", cmd_raidradius, pass_args=True))
